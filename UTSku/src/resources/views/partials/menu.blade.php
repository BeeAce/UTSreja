<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @endcan
        @can('sample_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is('admin/vehicles*') ? 'c-show' : '' }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                    ...
                    @can('vehicle_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route('admin.vehicles.index') }}"
                                class="c-sidebar-nav-link {{ request()->is('admin/books') || request()->is('admin/books/*') ? 'c-active' : '' }}">
                                <i class="fa-fw fas fa-car-side c-sidebar-nav-icon">
